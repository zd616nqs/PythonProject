# ------算数运算符---------
# 加减乘除+ - * / %   
# 除法：python3中，两个int值相除，结果必是float类型 4/2=2.0   
#      在python2中结果是整数忽略小数点后数值
...
print(-5 // 2)   # 结果：int类型 -3 注意：向下取整 寻找最近且数值较小的那个整数 
...
# ------------成员运算符----------
# in和not in
if 'niu' in 'niuqingshan':
    print('存在')
else:
    print('不存在')
    
if 'niu' not in 'niuqingshan':
    print('存在')
else:
    print('不存在')
